...
class HrExpenseMaScale(models.Model):
    ...
    _order = "start_date desc, vehicle_type, fuel_type, horsepower_min, distance_min"
    ...
    @api.depends("start_date", "vehicle_type", "fuel_type", "horsepower_min", "horsepower_max", "distance_min", "distance_max")
    def _compute_name(self):
        for scale in self:
            ...
            scale.name = f"{scale.start_date} - {scale.vehicle_type} - {scale.fuel_type} "
